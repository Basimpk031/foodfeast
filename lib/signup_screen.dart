...
class _SignUpScreenState extends State<SignUpScreen>
  ...
  // ── Photo URL picker ──────────────────────────────────────────────
  void _pickPhotoUrl() {
    final urlCtrl = TextEditingController(text: _photoUrl);
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.link_rounded, color: _primary),
            filled: true,
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              setState(() => _photoUrl = urlCtrl.text.trim());
  ...
  Future<void> _signUpAsCustomer() async {
    ...
    try {
      ...
      if (_photoUrl != null && _photoUrl!.isNotEmpty) {
        await cred.user!.updatePhotoURL(_photoUrl);
      }
                ...
                child: ClipOval(
                  child: _photoUrl != null && _photoUrl!.isNotEmpty
                      ...
                      : const Icon(Icons.person_rounded,
                          size: 40, color: Color(0xFFE5E5EA)),
                ),
              ),
              Container(
                width: 24, height: 24,
